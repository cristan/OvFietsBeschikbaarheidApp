...
class HomeViewModel(
    ...
    val pricePer24Hours: State<String?>
            ...
            currentlyShown is HomeContent.GpsContent -> {
                ...
                if (inWholeMinutes >= 5) {
                    ...
                    if (currentContent is HomeContent.GpsContent) {
                        content.value = currentContent.copy(isRefreshing = true)
                        refresh()
                    }
                }
            }
    ...
    private fun awaitAndShowLocationsWithDistance() {
        loadGpsLocationJob = viewModelScope.launch {
            ...
            try {
                ...
                if (content.value !is HomeContent.GpsContent) {
                    ...
                    if (fastCoordinates == null) {
                        ...
                        if (lastKnownCoordinates != null) {
                            ...
                            content.value = HomeContent.GpsContent(locationsWithDistance, Clock.System.now(), isRefreshing = true)
                        }
                    }
                }
                ...
                if (loadedCoordinates == null) {
                    content.value = HomeContent.NoGpsLocation
                } else {
                    ...
                    content.value = HomeContent.GpsContent(locationsWithDistance, Clock.System.now())
